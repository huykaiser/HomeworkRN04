...
export default class Homework5 extends Component {
    ...
    onPressEmoji = (icon) => {
        switch(icon){
            ...
            case 'love': this.setState({pic: require('../images/emoji/angry.png')}); break;
            case 'sad': this.setState({pic: require('../images/emoji/care.png')}); break;
            case 'like': this.setState({pic: require('../images/emoji/angry.png')}); break;
        }    
    }
